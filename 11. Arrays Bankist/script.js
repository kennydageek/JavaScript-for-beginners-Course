...
console.log(arr.slice()); // Creates shallow copy like the spread operator
...
// simplifying Maps callback function
const movementsUSD = movements.map(mov => mov * eurToUsd);

console.log(movements);
console.log(movementsUSD);

// Converting with ForOf
...
// Achieving Filter with ForOf loop
const depositsFor = [];
...
// Achieving the same thing with forOf loop
let balance2 = 0;
...
for (const [i, acc] of accounts.entries()) {
  if (accounts[i].owner === 'Jessica Davis') console.log(accounts[i]);
  else continue;
}
