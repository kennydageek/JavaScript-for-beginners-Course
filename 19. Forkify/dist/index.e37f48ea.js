...
var _stable = require("../../node_modules/core-js/stable");
...
},{"./model.js":"Y4A21","./views/recipeView.js":"l60JC","../../node_modules/core-js/stable":"7CRIE","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const updateServings = function(newServings) {
    ...
    // nowQt = oldQt * newServings / oldServings // 2 * 8 / 4 = 4
    });
...
const TIMEOUT_SEC = 70;
const RES_PER_PAGE = 10;
const KEY = 'd002d28c-fbab-4c55-baf6-8d147de99d6a';
...
},{"url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7CRIE":[function(require,module,exports) {
...
},{"../internals/function-call":"d7JlP","../internals/get-built-in":"6ZUSY","../internals/well-known-symbol":"gTwyA","../internals/redefine":"1ZKnU"}],"ffT5i":[function(require,module,exports) {
var defineProperty = require('../internals/object-define-property').f;
var hasOwn = require('../internals/has-own-property');
var wellKnownSymbol = require('../internals/well-known-symbol');
var TO_STRING_TAG = wellKnownSymbol('toStringTag');
...
},{"../internals/global":"i8HOC","../internals/is-callable":"l3Kyn"}],"2KCqj":[function(require,module,exports) {
var defineProperty = require('../internals/object-define-property').f;
...
if (!IS_PURE && isCallable(NativePromiseConstructor)) {
    ...
    if (NativePromisePrototype['catch'] !== method) redefine(NativePromisePrototype, 'catch', method, {
        unsafe: true
    });
}

},{"../internals/export":"dIGt4","../internals/is-pure":"5ZsyC","../internals/promise-constructor-detection":"hrijU","../internals/promise-native-constructor":"5gpdN","../internals/get-built-in":"6ZUSY","../internals/is-callable":"l3Kyn","../internals/redefine":"1ZKnU"}],"bayjl":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var call = require('../internals/function-call');
var aCallable = require('../internals/a-callable');
...
if (!IS_PURE && isCallable(NativePromiseConstructor)) {
    ...
    if (NativePromisePrototype['finally'] !== method) redefine(NativePromisePrototype, 'finally', method, {
        unsafe: true
    });
}

},{"../internals/export":"dIGt4","../internals/is-pure":"5ZsyC","../internals/promise-native-constructor":"5gpdN","../internals/fails":"hL6D2","../internals/get-built-in":"6ZUSY","../internals/is-callable":"l3Kyn","../internals/species-constructor":"cIK3T","../internals/promise-resolve":"42FWx","../internals/redefine":"1ZKnU"}],"ac5t0":[function(require,module,exports) {
var $ = require('../internals/export');
...
},{"../internals/descriptors":"92ZIi","../internals/global":"i8HOC","../internals/function-uncurry-this":"7GlkT","../internals/is-forced":"6uTCZ","../internals/inherit-if-required":"6UnCZ","../internals/create-non-enumerable-property":"8CL42","../internals/object-get-own-property-names":"fjY04","../internals/object-is-prototype-of":"3jtKQ","../internals/is-regexp":"hR496","../internals/to-string":"a1yl4","../internals/regexp-flags":"9bz1x","../internals/regexp-sticky-helpers":"dG6kl","../internals/proxy-accessor":"2KCqj","../internals/redefine":"1ZKnU","../internals/fails":"hL6D2","../internals/has-own-property":"gC2Q5","../internals/internal-state":"7AMlF","../internals/set-species":"5UUiu","../internals/well-known-symbol":"gTwyA","../internals/regexp-unsupported-dot-all":"7w3XA","../internals/regexp-unsupported-ncg":"j2d9g"}],"hR496":[function(require,module,exports) {
var isObject = require('../internals/is-object');
var classof = require('../internals/classof-raw');
var wellKnownSymbol = require('../internals/well-known-symbol');
var MATCH = wellKnownSymbol('match');
...
},{"../internals/global":"i8HOC","../internals/function-uncurry-this":"7GlkT"}],"l4tPF":[function(require,module,exports) {
'use strict';
// TODO: in core-js@4, move /modules/ dependencies to public entries for better optimization by tools like `preset-env`
require('../modules/es.array.iterator');
var $ = require('../internals/export');
