...
*/
/*
// Destructuring Arrays: Used to retrieve element from arrays and store them in a variable
...
// Retrieving and storing arrays into variables without destructuring
const arr = [2, 3, 4];
const a = arr[0];
const b = arr[1];
const c = arr[2];
...
console.log('..... OR .....');
// Use ANY data, return ANY data type, short circuiting
console.log(3 || 'jonas');
...
const restaurant = {
  ...
  orderPizza(mainIngredient, ...otherIngredinets) {
    console.log(mainIngredient);
    console.log(otherIngredinets);
  },
};
...
console.log(maskCreditCard(43189348));
console.log(maskCreditCard('5424598549845'));
